...
//       {/* MOBILE DRAWER */}
//       <div
//         className={`fixed top-0 right-0 h-full w-64 z-50 transition-transform ${
//           isOpen ? "translate-x-0" : "translate-x-full"
//         }`}
//         style={{ backgroundColor: primary }}
//       >
...
export default function Navbar() {
  ...
  // ✅ COUNSELLOR LOGOUT (COOKIE + CONTEXT)
  const handleCounsellorLogout = async () => {
    // await logout(); // clears cookie + role
